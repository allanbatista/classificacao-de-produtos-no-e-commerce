...
% O \textbf{Attention Mechanism} (Mecanismo de Atenção em tradução direta) introduzido por \cite{attention} consiste em prestar atenção com maior intensidade em algumas partes do todo.
